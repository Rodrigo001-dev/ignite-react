![to-do-image](https://github.com/Rodrigo001-dev/ignite-react/blob/main/react-2021/desafios/ignite-challenge-01/.github/to-do.png)

## :page_with_curl: Projeto

> <b>Primeiro Desafio</b> da trilha React de 2021 do ignite da [Rocketseat](https://github.com/Rocketseat), que tem por objetivo criar um TO-DO e que seja possível adiconar uma nova tarefa, colocar a tarefa como feita e remover uma tarefa.
...
$ cd react-2021/desafios/ignite-challenge-01
```
