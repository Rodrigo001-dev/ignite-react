![gif-preview](https://github.com/Rodrigo001-dev/ignite-react/blob/main/react-2021/desafios/ignite-challenge-02/.github/preview.gif)

## :page_with_curl: Projeto

> <b>Segundo Desafio</b> da trilha React de 2021 da [Rocketseat](https://github.com/Rocketseat), que tem por objetivo realizar a separação da aplicação em componentes, reforçando bem esse conceito de componentização no React.
...
$ cd react-2021/desafios/ignite-challenge-02
```
