...
> <b>DT money</b> é a terceira aplicação da trilha ReactJS de 2023 do Ignite da [Rocketseat](https://github.com/Rocketseat). Essa é uma aplicação de finanças que tem por objetivo você cadastrar as suas entradas(positivo) e suas saídas(negativo), com isso podendo visualizar a listagem de tudo o que foi cadastrado. Nela o objetivo foi aprender a fazer requisições HTTP e como melhorar a performance de uma aplicação React
...
$ cd react-2023/aulas/03-dt-money
```
