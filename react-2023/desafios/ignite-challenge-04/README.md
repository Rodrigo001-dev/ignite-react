...
> <b>Book Wise</b> é o quarto desafio da trilha React de 2023 do ignite da [Rocketseat](https://github.com/Rocketseat), que tem por objetivo criar uma aplicação FullStack de recomendações para leitores, um lugar onde eles possam avaliar e ver avaliações de outros leitores sobre os mais diversos livros.
...
$ cd react-2023/desafios/ignite-challenge-04
```
